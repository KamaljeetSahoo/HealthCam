...
//next steps
/*
Convert image to pose -> done
Show spheres on pose -> done
load and display a 3d model -> done
scale the 3d model -> done (tuning needed)
rotate the 3d model -> in progress
*/
